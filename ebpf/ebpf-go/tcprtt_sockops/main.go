...
// 指定 -type rtt_event 会为 eBPF 程序中的 struct rtt_event 生成对应的 Go 结构体
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -type rtt_event bpf tcprtt_sockops.c -- -I../../headers
